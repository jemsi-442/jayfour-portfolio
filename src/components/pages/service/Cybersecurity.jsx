...
export default function Cybersecurity() {
  const services = [
    ...
    },
    {
      ...
      description: "Secure network design, monitoring and threat prevention.",
    },
    {
      title: "Data Protection",
      description: "Data encryption, compliance, and secure storage solutions.",
    },
  ];

  return (
    <section className="py-20 px-6 md:px-20 bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-100">
      <h2 className="text-4xl font-bold mb-10">Cybersecurity Services</h2>
